...
CREATE INDEX `owner_id_idx` ON `items` (`owner_id`);--> statement-breakpoint
CREATE INDEX `category_idx` ON `items` (`category`);--> statement-breakpoint
CREATE INDEX `purchase_date_idx` ON `items` (`purchase_date`);--> statement-breakpoint
CREATE INDEX `owner_status_idx` ON `items` (`owner_id`,`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `mileage_date_idx` ON `mileage` (`date`);--> statement-breakpoint
CREATE INDEX `mileage_owner_idx` ON `mileage` (`owner_id`);--> statement-breakpoint
CREATE TABLE `photos` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `photo_item_id_idx` ON `photos` (`item_id`);--> statement-breakpoint
CREATE TABLE `sales` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`item_id` integer,
...
--> statement-breakpoint
CREATE INDEX `sold_date_idx` ON `sales` (`sold_date`);--> statement-breakpoint
CREATE INDEX `item_id_idx` ON `sales` (`item_id`);--> statement-breakpoint
CREATE INDEX `platform_idx` ON `sales` (`platform`);--> statement-breakpoint
CREATE INDEX `sold_by_idx` ON `sales` (`sold_by`);--> statement-breakpoint
CREATE INDEX `sold_by_date_idx` ON `sales` (`sold_by`,`sold_date`);--> statement-breakpoint
CREATE TABLE `users` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`email` text NOT NULL,
