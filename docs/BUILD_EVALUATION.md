...
> **Re-evaluation log:** 2026-07-17 — composite-formula re-rank (no new branch). Ranks recomputed by the weighted composite formula (`BUILD_EVAL_PROMPT.md` STEP 6.2) from existing stars + functional scores; no static analysis or tests re-run. Deltas: vscode-5.2 6→2, opencode-5.2 4→3, pi-5.2 5→4, claude-5.1 2→5, opencode-minimax-m3 3→6; claude-5.2 #1, opencode-5.1 #7, pi-5.1 #8, codex-5.2 #9 hold. See §11 for the full log.
...
| **2** | `build-vscode-glm-5.2` | ★★★★☆ | ★★★★☆ | ★★★★☆ | ★★★★☆ | ★★★☆☆ (100 tests, lint broken) | 96/100 | 4.02 |
| **3** | `build-opencode-glm-5.2` | ★★★★☆ | ★★★★☆ | ★★★★★ | ★★★☆☆ | ★★★☆☆ (134 tests, lint broken) | 88/100 | 4.01 |
| **4** | `build-pi-glm-5.2` | ★★★★☆ | ★★★☆☆ | ★★★★☆ | ★★★★★ | ★★★☆☆ (137 tests, lint broken) | 96/100 | 3.97 |
| **5** | `build-claude-glm-5.1` | ★★★★★ | ★★★★★ | ★★★★☆ | ★★★★☆ | ★★★☆☆ (121 tests, lint 11 err) | 35/100 | 3.96 |
| **6** | `build-opencode-minimax-m3` | ★★★★☆ | ★★★★☆ | ★★★☆☆ | ★★★★☆ | ★★★☆☆ (135 tests, lint broken) | 96/100 | 3.82 |
...
**Composite scores** (ranks 1..9, ordered by composite descending per `BUILD_EVAL_PROMPT.md` STEP 6.2): claude-5.2 **4.85** (#1), vscode-5.2 **4.02** (#2), opencode-5.2 4.01 (#3), pi-5.2 3.97 (#4), claude-5.1 3.96 (#5), opencode-minimax-m3 3.82 (#6), opencode-5.1 3.62 (#7), pi-5.1 2.96 (#8), codex-5.2 **2.65** (#9). The composite is the weighted aggregate of the five dimension stars + functional score, and **is the rank determinant** — every rank above is assigned by composite descending (no ties to 2 d.p. occurred, so no tie-breaker was invoked).
