...
| **3** | `build-opencode-minimax-m3` | ★★★★☆ | ★★★★☆ | ★★★☆☆ | ★★★★☆ | 15 files / 135 tests / lint script broken |
| **4** | `build-opencode-glm-5.2` | ★★★★☆ | ★★★★☆ | ★★★★★ | ★★★☆☆ | 12 files / 134 tests / lint script broken |
| **5** | `build-pi-glm-5.2` | ★★★★☆ | ★★★☆☆ | ★★★★☆ | ★★★★★ | 14 files / 137 tests / lint script broken |
| **6** | `build-vscode-glm-5.2` | ★★★★☆ | ★★★★☆ | ★★★★☆ | ★★★★☆ | 9 files / 100 tests / lint script broken |
| **7** | `build-opencode-glm-5.1` | ★★★★☆ | ★★★☆☆ | ★★★★☆ | ★★★★☆ | 14 files / 115 tests / lint exit 1 (119 err) |
| **8** | `build-pi-glm-5.1` | ★★★☆☆ | ★★★☆☆ | ★★☆☆☆ | ★★★★☆ | 9 files / 95 tests / lint script broken |
| **9** | `build-codex-glm-5.2` | ★★★★☆ | ★★☆☆☆ | ★★★☆☆ | ★★★★★ | 7 files (77 pass / 16 fail) / **tsc exit 1 (101 err)** / lint script broken |
