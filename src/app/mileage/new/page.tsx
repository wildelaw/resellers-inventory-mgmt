    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Add Mileage Entry</h1>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="number" required min="0.1" step="0.1" value={miles} onChange={e => setMiles(e.target.value)} className={inputClass} placeholder="0.0" />
              </div>
            </div>
